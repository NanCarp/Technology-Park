...
public class ParkManageController extends Controller {
	...
	public void saveEmp(){
		...
		byte[] pass =MD5Util.hexStringToByte(getPara("emppassword1"));
	...
	public void savePayment(){
		...
		boolean result = ParkManageService.savePayment(id, year, quarterly, company_name, should_pay_rent, paid_rent, property_costs, paid_property_charges, should_pay_water, real_water_fee);
		renderJson("result",result);
	}
	//根据id删除缴费信息
	public void delPay(){
	...
	public void saveNotice(){
		...
		boolean result = ParkManageService.saveNotice(id, title, content);
		renderJson("result",result);
	}
